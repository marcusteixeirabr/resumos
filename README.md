...
| **Database Design for Apps** | Conceitos de banco de dados, tipos (relacional, hierárquico, em rede, objeto-relacional), modelagem e linguagens SQL, arquitetura de BD, SGBDs | 🟡 8/16 UAs em andamento |
