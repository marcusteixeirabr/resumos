...
| **Programming and Data Persistence** | Manipulação de arquivos, tipos de arquivos, operações I/O, acesso sequencial e direto, DOM | 🟡 13/16 UAs em andamento |
| **Database Design for Apps** | Conceitos de banco de dados, tipos (relacional, hierárquico, em rede, objeto-relacional), modelagem e linguagens SQL, arquitetura de BD, SGBDs | 🟡 13/16 UAs em andamento |
