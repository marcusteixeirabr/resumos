...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_07.png" alt="A UML como Extensão do Pensamento" caption="UML como rascunho ágil e como planta definitiva" />
  <SlideItem src="/assets/img/slides/mub_08.png" alt="A planta baixa que evita a refatoração dolorosa" caption="Estrutura, comportamento e arquitetura — os três eixos da UML" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_09.png" alt="A anatomia estrutural: Dissecando a Classe" caption="Identificador, estado (atributos) e comportamento (métodos)" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_10.png" alt="Controle de acesso lógico: Visibilidade" caption="Public, private, protected e package — controle de acoplamento" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_12.png" alt="Multiplicidade: Traduzindo regras de negócio" caption="Cada notação expressa uma regra de negócio real" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_11.png" alt="O Espectro de Relacionamentos: Medindo o Acoplamento" caption="Do acoplamento fraco (dependência) ao forte (herança) — escolha consciente" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_06.png" alt="Matriz Diagnóstica: Escolhendo a Ferramenta Certa" caption="Classes vs. Sequência vs. Componentes — quando usar cada diagrama" />
</SlidesGrid>
