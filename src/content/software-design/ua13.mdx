...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_13.png" alt="A Quarta Dimensão: Mapeando o Tempo" caption="Eixo X = participantes simultâneos; eixo Y = progressão temporal" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_14.png" alt="O Dicionário de Comunicação Dinâmica" caption="Síncrona, assíncrona, retorno, create e destroy — a gramática das mensagens" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_15.png" alt="Fragmentos Combinados: Programação Visual" caption="loop, alt e opt — lógica processual expressa visualmente no diagrama" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_02.png" alt="Na Prática: O Padrão MVC em Tempo Real" caption="Diagrama de sequência completo — Usuário → View → Controller → Model" />
</SlidesGrid>
