...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/rdb_10.png" alt="A Linha de Montagem do Arquiteto de Software" caption="Fase 1 Conceitual (MER) → Fase 2 Lógico → Fase 3 Físico (SQL)" />
</SlidesGrid>

<SlidesGrid>
  <SlideItem src="/assets/img/slides/btc_03.png" alt="O Conceito Base: MER" caption="O conceito base: MER" />
  <SlideItem src="/assets/img/slides/btc_04.png" alt="Entidades Físicas vs Lógicas" caption="Entidades físicas vs. lógicas" />
  <SlideItem src="/assets/img/slides/btc_05.png" alt="Hierarquia de Entidades" caption="Hierarquia de dependência" />
  <SlideItem src="/assets/img/slides/btc_06.png" alt="Atributos" caption="Atributos: o raio-X do objeto" />
  <SlideItem src="/assets/img/slides/btc_07.png" alt="DER: O Desenho Formal" caption="DER: o desenho formal da arquitetura" />
  <SlideItem src="/assets/img/slides/btc_08.png" alt="Notações" caption="Peter Chen vs. Padrão UML" />
  <SlideItem src="/assets/img/slides/rdb_11.png" alt="Fase 1: Abstraindo a Clínica Veterinária" caption="Tutor, Animal e Veterinário — identificando entidades, atributos e relacionamentos" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btc_09.png" alt="Cardinalidades" caption="Cardinalidade: a matemática do relacionamento" />
  <SlideItem src="/assets/img/slides/rdb_12.png" alt="O Diagrama Entidade-Relacionamento (DER)" caption="DER completo da clínica veterinária com cardinalidades" />
</SlidesGrid>
