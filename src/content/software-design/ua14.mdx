...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btc_01.png" alt="Da Planta ao Código" caption="Da Planta ao Código" />
  <SlideItem src="/assets/img/slides/btc_02.png" alt="A Escalabilidade Exige Engenharia" caption="A escalabilidade exige engenharia" />
  <SlideItem src="/assets/img/slides/btc_14.png" alt="Ciclo de Vida da Engenharia de Dados" caption="Ciclo de vida da engenharia de dados" />
  <SlideItem src="/assets/img/slides/rdb_07.png" alt="Da Desordem à Estrutura" caption="Do caos do mundo real ao modelo matemático do PostgreSQL" />
  <SlideItem src="/assets/img/slides/rdb_08.png" alt="Anatomia do Sistema Relacional" caption="Database → Tables → Rows → Columns — a hierarquia relacional" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btc_10.png" alt="PK e FK" caption="A Estrutura Física: PK & FK" />
  <SlideItem src="/assets/img/slides/btc_11.png" alt="O Triunfo da FK" caption="O segredo da escalabilidade: FK vs. redundância" />
</SlidesGrid>

### SQL — DDL e DML

<SlidesGrid>
  <SlideItem src="/assets/img/slides/btc_12.png" alt="SQL: DDL e DML" caption="SQL: DDL e DML" />
  <SlideItem src="/assets/img/slides/btc_13.png" alt="Anatomia de uma consulta" caption="Anatomia de uma consulta SELECT" />
  <SlideItem src="/assets/img/slides/rdb_09.png" alt="A Caixa de Ferramentas: Taxonomia SQL" caption="DDL, DML, DQL, DCL e DTL — cada sublinguagem e seu papel" />
  <SlideItem src="/assets/img/slides/rdb_06.png" alt="A Peça Fundamental do Ecossistema Web" caption="Client → Web Tier → Business Tier → EIS (banco de dados)" />
</SlidesGrid>
