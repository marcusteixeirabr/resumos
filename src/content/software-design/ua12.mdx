...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_03.png" alt="Módulos e Caixas Pretas: A Visão de Alto Nível" caption="Componentes ocultam complexidade interna e expõem apenas o necessário" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_04.png" alt="A Arte do Encaixe: Interfaces e Portas" caption="Interface fornecida (pirulito) e requerida (soquete) — o encaixe que define a arquitetura" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/mub_05.png" alt="Componentes no Mundo Real: SOA e Web Services" caption="Microsserviços conectados por ESB — interoperabilidade via contratos rígidos" />
</SlidesGrid>
