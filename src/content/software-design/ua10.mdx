...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btr_07.png" alt="Wireframes — Média Fidelidade" caption="Wireframes: arquitetura da informação" />
  <SlideItem src="/assets/img/slides/btr_08.png" alt="Alta Fidelidade" caption="Alta fidelidade: simulação final" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btr_10.png" alt="Ecossistema de Ferramentas" caption="Ferramentas por nível de fidelidade" />
</SlidesGrid>
...
Referências: ROCHA, H.V.; BARANAUSKAS, M.C.C. *Design e Avaliação de Interfaces Humano-Computador*, 2003. BARBOSA, S.D.J.; SILVA, B.S. *Interação Humano-Computador*, 2010. ROGERS, Y.; SHARP, H.; PREECE, J. *Design de Interação*, 3ª ed., 2013.
