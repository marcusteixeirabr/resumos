...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btr_01.png" alt="Do Esboço à Realidade" caption="Do Esboço à Realidade" />
  <SlideItem src="/assets/img/slides/btr_02.png" alt="Ponte de comunicação" caption="Protótipo como ponte de comunicação" />
  <SlideItem src="/assets/img/slides/btr_03.png" alt="Circuito de Prototipação" caption="O motor do design: ciclo iterativo" />
  <SlideItem src="/assets/img/slides/btr_11.png" alt="ROI da Prototipação" caption="O verdadeiro ROI da Prototipação" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btr_05.png" alt="Espectro de Fidelidade" caption="O espectro de fidelidade" />
  <SlideItem src="/assets/img/slides/btr_09.png" alt="Mapa de Decisão" caption="Mapa de decisão por fidelidade" />
  <SlideItem src="/assets/img/slides/btr_06.png" alt="Baixa Fidelidade" caption="Baixa fidelidade: validando com papel" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/btr_04.png" alt="Cenários antes das telas" caption="Projetar cenários antes das telas" />
</SlidesGrid>
...
Referências: ROGERS, Y.; SHARP, H.; PREECE, J. *Design de Interação: além da interação humano-computador*, 3ª ed., 2013. BARANAUSKAS, M.C.C.; ROCHA, H.V. *Design e Avaliação de Interfaces Humano-Computador*, 2003.
