...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/psa_07.webp" alt="Escalabilidade: do Código Puro ao Framework — Composer (gerenciamento de dependências) e Zend 5 (framework com biblioteca de componentes)" caption="Escalabilidade: Ferramentas e Frameworks PHP" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/wab_06.webp" alt="Arquitetura MVC: fluxo View → Controller → Model → View com exemplo de login" caption="Arquitetura MVC — fluxo de uma requisição" />
  <SlideItem src="/assets/img/slides/psa_08.webp" alt="Arquitetura de Software: O Padrão MVC — Model (regras e validação), View (exibição sem lógica), Controller (maestro que controla o fluxo) — Separation of Concerns" caption="MVC: Separação de Responsabilidades" />
</SlidesGrid>
