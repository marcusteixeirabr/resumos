...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/psa_05.webp" alt="Interatividade Web: Formulários HTML e PHP — ciclo Browser → Servidor, comparação GET vs POST, captura com $_GET e $_POST" caption="Formulários HTML + PHP: GET vs POST" />
</SlidesGrid>
