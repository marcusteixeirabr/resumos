...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/psa_06.webp" alt="Persistência: O Ecossistema CRUD com PDO — Create (form_insct.php), Read (lista.php), Update (form_altera.php), Delete (exclui.php)" caption="Persistência: O Ecossistema CRUD com PDO" />
</SlidesGrid>
