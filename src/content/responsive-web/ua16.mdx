...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/wab_01.webp" alt="A Arquitetura da Web: Do Macro ao Micro — design de sistemas, SDLC e padrões MVC, Singleton e Factory" caption="A Arquitetura da Web: Do Macro ao Micro" />
  <SlideItem src="/assets/img/slides/wab_07.webp" alt="Tipologia dos Padrões de Projeto: MVC (Arquitetura Estrutural), Singleton e Factory (Criação de Objetos)" caption="Tipologia dos Padrões de Projeto" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/wab_08.webp" alt="Padrão Singleton: construtor privado, getInstance() e única instância na memória" caption="Padrão Singleton" />
  <SlideItem src="/assets/img/slides/psa_09.webp" alt="Engenharia Profissional: Padrões de Projeto — Singleton (única instância, getInstance()) vs Factory (fábrica de objetos, desacopla criação)" caption="Singleton vs Factory: visão comparativa" />
</SlidesGrid>
...
<SlidesGrid>
  <SlideItem src="/assets/img/slides/wab_09.webp" alt="Padrão Factory: interface central, fábrica intermediária e alta flexibilidade na criação de objetos" caption="Padrão Factory" />
  <SlideItem src="/assets/img/slides/wab_10.webp" alt="O Modelo Unificado da Engenharia Web: Controller (MVC) + Factory + Model + Singleton + View" caption="O Modelo Unificado da Engenharia Web" />
  <SlideItem src="/assets/img/slides/psa_10.webp" alt="Síntese: A Anatomia de uma Aplicação PHP — Formulário UI → Controller (MVC) → Model → MySQL (CRUD) + Singleton, estruturas de controle e arrays no fluxo completo" caption="Síntese: A Anatomia de uma Aplicação PHP" />
</SlidesGrid>
